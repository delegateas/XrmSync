...
namespace DG.XrmPluginSync.Dataverse.Context
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<DG.XrmPluginSync.Dataverse.Context.SdkMessageProcessingStep>? SdkMessageFilterId_SdkMessageProcessingStep
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<DG.XrmPluginSync.Dataverse.Context.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<DG.XrmPluginSync.Dataverse.Context.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public DG.XrmPluginSync.Dataverse.Context.SystemUser? CreatedBy_SdkMessageFilter
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("createdby_sdkmessagefilter", null);
			}
		}
		...
		public DG.XrmPluginSync.Dataverse.Context.SystemUser? Lk_SdkMessageFilter_CreatedOnBehalfBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("lk_sdkmessagefilter_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("lk_sdkmessagefilter_createdonbehalfby", null, value);
			}
		}
		...
		public DG.XrmPluginSync.Dataverse.Context.SystemUser? Lk_SdkMessageFilter_ModifiedOnBehalfBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("lk_sdkmessagefilter_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("lk_sdkmessagefilter_modifiedonbehalfby", null, value);
			}
		}
		...
		public DG.XrmPluginSync.Dataverse.Context.SystemUser? ModifiedBy_SdkMessageFilter
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SystemUser>("modifiedby_sdkmessagefilter", null);
			}
		}
		...
		public DG.XrmPluginSync.Dataverse.Context.SdkMessage? SdkMessageId_SdkMessageFilter
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<DG.XrmPluginSync.Dataverse.Context.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}

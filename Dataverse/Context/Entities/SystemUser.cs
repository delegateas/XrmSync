...
namespace XrmSync.Dataverse.Context
{
	...
	public partial class SystemUser : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<XrmSync.Dataverse.Context.WebResource>? Lk_WebResourceBase_CreatedOnBehalfBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("lk_webresourcebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("lk_webresourcebase_createdonbehalfby", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<XrmSync.Dataverse.Context.WebResource>? Lk_WebResourceBase_ModifiedOnBehalfBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("lk_webresourcebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("lk_webresourcebase_modifiedonbehalfby", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<XrmSync.Dataverse.Context.WebResource>? WebResource_CreatedBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("webresource_createdby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("webresource_createdby", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<XrmSync.Dataverse.Context.WebResource>? WebResource_ModifiedBy
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("webresource_modifiedby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntities<XrmSync.Dataverse.Context.WebResource>("webresource_modifiedby", null, value);
			}
		}

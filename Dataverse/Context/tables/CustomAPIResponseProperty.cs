...
/// <summary>
/// <para>Entity that defines a response property for a custom API</para>
/// <para>Display Name: Custom API Response Property</para>
/// </summary>
...
public partial class CustomAPIResponseProperty : ExtendedEntity
#pragma warning restore CS8981
{
    ...
    public override Guid Id {
        ...
        set {
            SetId("customapiresponsepropertyid", value);
        }
    }
    ...
    /// <summary>
    /// <para>Unique identifier for the custom API that owns this custom API response property</para>
    ...
    {
        get => GetAttributeValue<Guid>("customapiresponsepropertyid");
        set => SetId("customapiresponsepropertyid", value);
    }

    /// <summary>
    /// <para>Localized description for custom API response property instances</para>
    ...
    /// <summary>
    /// <para>Localized display name for custom API response property instances</para>
    ...
    /// <summary>
    /// <para>The logical name of the entity bound to the custom API response property</para>
    ...
    /// <summary>
    /// <para>The primary name of the custom API response property</para>
    ...
    /// <summary>
    /// <para>Status of the Custom API Response Property</para>
    /// <para>Display Name: Status</para>
    /// </summary>
    [AttributeLogicalName("statecode")]
    [DisplayName("Status")]
    public customapiresponseproperty_statecode? statecode
    {
        get => this.GetOptionSetValue<customapiresponseproperty_statecode>("statecode");
        set => this.SetOptionSetValue("statecode", value);
    }

    /// <summary>
    /// <para>Reason for the status of the Custom API Response Property</para>
    /// <para>Display Name: Status Reason</para>
    /// </summary>
    [AttributeLogicalName("statuscode")]
    [DisplayName("Status Reason")]
    public customapiresponseproperty_statuscode? statuscode
    {
        get => this.GetOptionSetValue<customapiresponseproperty_statuscode>("statuscode");
    ...
    /// <summary>
    /// <para>The data type of the custom API response property</para>
    ...
    /// <summary>
    /// <para>Unique name for the custom API response property</para>
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_customapiresponseproperty_createdby", null);
        set => SetRelatedEntity("lk_customapiresponseproperty_createdby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_customapiresponseproperty_createdonbehalfby", null);
        set => SetRelatedEntity("lk_customapiresponseproperty_createdonbehalfby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_customapiresponseproperty_modifiedby", null);
        set => SetRelatedEntity("lk_customapiresponseproperty_modifiedby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<SystemUser>("lk_customapiresponseproperty_modifiedonbehalfby", null);
        set => SetRelatedEntity("lk_customapiresponseproperty_modifiedonbehalfby", null, value);
    }
    ...
    {
        get => GetRelatedEntity<CustomAPI>("customapi_customapiresponseproperty", null);
        set => SetRelatedEntity("customapi_customapiresponseproperty", null, value);
    }

    /// <summary>
    /// Gets the logical column name for a property on the CustomAPIResponseProperty entity, using the AttributeLogicalNameAttribute if present.
    /// </summary>
    ...
    public static string GetColumnName(Expression<Func<CustomAPIResponseProperty, object>> column)
    {
        return TableAttributeHelpers.GetColumnName(column);
    }

    /// <summary>
    /// Retrieves the CustomAPIResponseProperty with the specified columns.
    /// </summary>
    /// <param name="service">Organization service</param>
    /// <param name="id">Id of CustomAPIResponseProperty to retrieve</param>
    /// <param name="columns">Expressions that specify columns to retrieve</param>
    /// <returns>The retrieved CustomAPIResponseProperty</returns>
    public static CustomAPIResponseProperty Retrieve(IOrganizationService service, Guid id, params Expression<Func<CustomAPIResponseProperty, object>>[] columns)
    {
        return service.Retrieve(id, columns);
    }

    /// <summary>
    /// Retrieves the CustomAPIResponseProperty using the Custom API Response Property Export Key alternate key.
    /// </summary>
    /// <param name="service">Organization service</param>
    ...
    /// <param name="columns">Expressions that specify columns to retrieve</param>
    /// <returns>The retrieved CustomAPIResponseProperty</returns>
    public static CustomAPIResponseProperty Retrieve_CustomAPIResponsePropertyExportKey(IOrganizationService service, componentstate ComponentState, Guid CustomAPIId, DateTime OverwriteTime, string UniqueName, params Expression<Func<CustomAPIResponseProperty, object>>[] columns)
    {

...
#pragma warning restore CS8981
{
	...
	[RelationshipMetadata("ManyToOne", "publisherid", "publisher", "publisherid", "Referencing")]
	public Publisher publisher_solution
	{
		get => GetRelatedEntity<Publisher>("publisher_solution", null);
		set => SetRelatedEntity("publisher_solution", null, value);
	}
	...
	[RelationshipMetadata("ManyToOne", "configurationpageid", "webresource", "webresourceid", "Referencing")]
	public WebResource solution_configuration_webresource
	{
		get => GetRelatedEntity<WebResource>("solution_configuration_webresource", null);
		set => SetRelatedEntity("solution_configuration_webresource", null, value);
	}
	...
	[RelationshipMetadata("OneToMany", "solutionid", "dependencynode", "basesolutionid", "Referenced")]
	public IEnumerable<DependencyNode> solution_base_dependencynode
	{
		get => GetRelatedEntities<DependencyNode>("solution_base_dependencynode", null);
		set => SetRelatedEntities("solution_base_dependencynode", null, value);
	}

	[RelationshipSchemaName("solution_top_dependencynode")]
	[RelationshipMetadata("OneToMany", "solutionid", "dependencynode", "topsolutionid", "Referenced")]
	public IEnumerable<DependencyNode> solution_top_dependencynode
	{
		get => GetRelatedEntities<DependencyNode>("solution_top_dependencynode", null);
		set => SetRelatedEntities("solution_top_dependencynode", null, value);
	}

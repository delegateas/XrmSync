...
#pragma warning restore CS8981
{
    ...
    [RelationshipMetadata("ManyToOne", "managedidentityid", "managedidentity", "managedidentityid", "Referencing")]
    public ManagedIdentity managedidentity_PluginAssembly
    {
        get => GetRelatedEntity<ManagedIdentity>("managedidentity_PluginAssembly", null);
        set => SetRelatedEntity("managedidentity_PluginAssembly", null, value);
    }

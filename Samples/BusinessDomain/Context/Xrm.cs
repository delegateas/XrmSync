...
namespace BusinessDomain.Context
{
	...
	public partial class Xrm : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// Constructor.
		/// </summary>
		public Xrm(Microsoft.Xrm.Sdk.IOrganizationService service) : 
				base(service)
		{
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="BusinessDomain.Context.Account"/> entities.
		/// </summary>
		public System.Linq.IQueryable<BusinessDomain.Context.Account> AccountSet
		{
			get
			{
				return this.CreateQuery<BusinessDomain.Context.Account>();
			}
		}
		
		/// <summary>
		/// Gets a binding to the set of all <see cref="BusinessDomain.Context.Lead"/> entities.
		/// </summary>
		public System.Linq.IQueryable<BusinessDomain.Context.Lead> LeadSet
		{
			get
			{
				return this.CreateQuery<BusinessDomain.Context.Lead>();
			}
		}
	}
